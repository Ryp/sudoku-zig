...
pub const jigsaw9 = KnownBoard{
    .rules = .{ .type = .{ .jigsaw = .{ .extent = 9, .box_indices_max = rules.fill_jigsaw_box_indices_from_string_max(9, "111111222113444422133455442334455222366657777366559997366659977386858997888888997") catch @compileError("Invalid jigsaw sudoku string") } } },
